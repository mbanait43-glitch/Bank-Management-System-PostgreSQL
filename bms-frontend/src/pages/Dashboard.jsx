  ...
  return (
    <div className="dashboard-shell">
      ...
      <main className="dashboard-main-area">
        ...
        {activePage === "home" && (
          <section>
            <div className="hero-card"><p className="hero-small">Secure Full Stack Banking Dashboard</p><h2>JWT protected banking with PostgreSQL cloud database storage</h2><p className="hero-desc">Manage account balance, deposit, withdraw, transfer money, view profile, download statement, and track transaction history.</p></div>
